...
<head>
    ...
    <title>Publicité des produits</title>
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="/">Liste des produits</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/create') }}">Nouveau</a>
                    </li>
                </ul>
                <form class="d-flex">
    ...
    @elseif($layout=='edit')
        <div class="container-fluid">
            <div class="row">
                <section class="col">@include('produitList')</section>
                <section class="col">@include('produitEdit')</section>
            </div>
        </div>
    @endif
